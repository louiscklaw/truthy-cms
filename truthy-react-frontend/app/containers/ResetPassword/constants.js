...
export const RESET_PASSWORD = "containers/ResetPassword/RESET_PASSWORD";
export const ADD_VALIDATION_ERROR = "containers/ResetPassword/ADD_VALIDATION_ERROR";
...
export const CLEAR_FORM_VALUES = "containers/ResetPassword/CLEAR_FORM_VALUES";
