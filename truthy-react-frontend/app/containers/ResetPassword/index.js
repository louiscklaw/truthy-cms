      ...
      <Row className="login-center">
        <Col xl={8} className="m-auto">
          ...
          >
              ...
              rules={[
                {
                  required: true,
                  whitespace: true,
                  message: <FormattedMessage {...commonMessages.confirmPasswordRequired} />,
                },
                {
            ...
            <FormButtonWrapper variant="primary" disabled={isLoading} form={form} label={messages.resetPasswordBtn} />
          </FormWrapper>
        </Col>
      </Row>
    </div>
