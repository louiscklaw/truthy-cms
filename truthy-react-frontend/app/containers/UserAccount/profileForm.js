...
import { makeIsLoadingSelector, makeLoggedInUserSelector } from "containers/App/selectors";
...
import { setFormValues, submitFormAction } from "containers/UserAccount/actions";
    ...
    <Row>
      <Col span={12}>
        ...
        >
          ...
          <FormButtonWrapper variant="primary" disabled={loading} form={form} label={commonMessage.submit} />
        </Form>
      </Col>
      <Col span={10} offset={2}>
        ...
        <div className="user-image">
          {user.avatar ? <img src={`${BASE_URL}/images/profile/${user.avatar}`} alt="avatar" /> : null}
        </div>
