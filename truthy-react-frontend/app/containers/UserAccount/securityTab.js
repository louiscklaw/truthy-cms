...
export default function SecurityTab() {
  ...
  const onToggleOtpField = val => {
    Modal.confirm({
      ...
      title: intl.formatMessage(val ? messages.activateOtpConfirm : messages.deactivateOtpConfirm),
  ...
  return (
    <>
      ...
      >
        <Form layout="vertical" form={form} name="user-account" className="change-password-form">
          <FormInputWrapper
            passwordInput
