...
export default defineMessages({
  ...
  browserDetail: {
    ...
    defaultMessage: "Logged in from browser: {browser} version: {version}. Login valid till: {ts, date, ::yyyyMMdd}",
  },
  otpLabel: {
    id: `${scope}.otpLabel`,
  ...
  activateOtpConfirm: {
    ...
    defaultMessage: "Are you sure you want to activate Two Factor Authentication?",
  },
  deactivateOtpConfirm: {
    id: `${scope}.deactivateOtpConfirm`,
    defaultMessage: "Are you sure you want to deactivate Two Factor Authentication?",
  },
  toggleTwoFaSuccess: {
