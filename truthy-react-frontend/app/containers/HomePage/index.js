...
import { makeContributorsSelector, makeIsLoadingSelector } from "containers/HomePage/selector";
  ...
  return (
    <div className="home-page">
      <div className="home-wrapper mh-100">
        <div className="side-img">{/* <img src={NavImg} className="img-fluid" alt="nav-img" /> */}</div>
        <Navbar />
        <Banner />
        <TruthyHelps />
