...
const Contributors = ({ contributors, loading = true }) => {
  ...
  return (
    <div className="contributors">
      <h3 className="text-center heading">{intl.formatMessage(messages.contribTitle)}</h3>
            ...
            {contributors?.map(item => (
              <Col xl={8} lg={8} sm={8} key={item.author}>
                <Card
                  ...
                  cover={
                    <img alt={item.author} src={`https://www.gravatar.com/avatar/${item.gravatar}?s=250&d=blank`} />
                  }
                >
