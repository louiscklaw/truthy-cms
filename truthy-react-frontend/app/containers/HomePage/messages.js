...
export default defineMessages({
  ...
  popularDescription: {
    ...
    defaultMessage: "Truthy is build with popular frameworks like NestJS and ReactJS. It is easy to use and maintain.",
  },
  securityTitle: {
  ...
  securityDescription: {
    ...
    defaultMessage: "Built-in authentication and authorization using JWT (refresh token concept). OTP module for 2FA.",
  },
  developmentTitle: {
  ...
  developmentDescription: {
    ...
    defaultMessage: "Easy to customize and extend each component, saving you time and money.",
  },
  moduleTitle: {
  ...
  moduleDescription: {
    ...
    defaultMessage: "Role based access controls, user management, Dashboard, Email modules, Security modules and more.",
  },
  customizeTitle: {
  ...
  deploymentDescription: {
    ...
    defaultMessage: "This CMS can be easily deployed and used all details are in the documentation.",
  },
});
