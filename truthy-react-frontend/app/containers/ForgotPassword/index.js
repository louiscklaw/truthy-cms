...
import { forgotPasswordAction, setFormValuesAction } from "containers/ForgotPassword/actions";
      ...
      <Row className="login-center">
        <Col xl={8} className="m-auto">
          ...
          >
            ...
            <FormButtonWrapper variant="primary" disabled={isLoading} form={form} label={messages.forgotPasswordBtn} />
          </FormWrapper>
        </Col>
      </Row>
    </div>
