...
import { asyncEndAction, asyncStartAction } from "containers/ForgotPassword/actions";
...
export function* handleForgotPassword() {
  ...
  const requestPayload = ApiEndpoint.makeApiPayload(requestUrl, PUT, formValues);
  try {
