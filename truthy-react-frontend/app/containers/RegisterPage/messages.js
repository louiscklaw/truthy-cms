...
export default defineMessages({
  ...
  internalError: {
    ...
    defaultMessage: "There was some error during process, please try again later",
  },
  helmetRegisterTitle: {
  ...
  registerSuccess: {
    ...
    defaultMessage: "Successfully registered, please check your email to activate your account!",
  },
  signBtn: {
    id: `${scope}.signBtn`,
