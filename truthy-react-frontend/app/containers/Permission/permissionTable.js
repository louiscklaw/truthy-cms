...
import { setPageNumberAction, setPageSizeAction } from "containers/Permission/actions";
import messages from "containers/Permission/messages";
import { makeIsLoadingSelector, makePermissionsSelector } from "containers/Permission/selectors";
  ...
  return (
    <>
      ...
      >
        ...
        />
        <Table.Column title={intl.formatMessage(messages.methodLabel)} dataIndex="method" key="method" width={100} />
        <Table.Column title={intl.formatMessage(messages.pathLabel)} dataIndex="path" key="path" width={100} />
        <Table.Column
