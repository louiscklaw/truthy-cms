...
const useGetPermissionForm = ({ responsive = false, formName = "role-form", initialValues, device }) => {
  ...
  const ResourceInput = () => {
    ...
    return responsive ? <Col {...wrapperCol}>{resourceInput}</Col> : resourceInput;
  };
  ...
  const DescriptionInput = () => {
    ...
    return responsive ? <Col {...wrapperCol}>{descriptionInput}</Col> : descriptionInput;
  };
