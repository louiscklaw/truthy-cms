...
import { clearFormAction, setFormValues, submitFormAction } from "containers/Permission/actions";
...
const CreatePermissionModal = ({ onCancel, visible }) => {
  ...
  const { Form, form, ResourceInput, DescriptionInput, MethodInput, PathInput } = useGetPermissionForm({
