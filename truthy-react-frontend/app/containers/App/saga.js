...
import { AUTHENTICATE_OTP, GET_PROFILE_REQUEST, LOGOUT, REFRESH_TOKEN } from "containers/App/constants";
...
export function* handleProfile() {
  ...
  try {
    ...
    response.image = response.image ? `${BASE_URL}/uploads/${response.data.image}` : "";
