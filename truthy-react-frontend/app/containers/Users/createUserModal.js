...
import { clearFormAction, setFormValues, submitFormAction } from "containers/Users/actions";
import { useDispatch, useSelector } from "react-redux";
import { createStructuredSelector } from "reselect";
import { makeClearFormFieldSelector, makeErrorSelector, makeRolesListSelector } from "containers/Users/selectors";
...
const CreateUserModal = ({ onCancel, visible }) => {
  ...
  const { Form, form, NameInput, EmailInput, StatusInput, UsernameInput, RoleInput } = useGetUserForm({
