...
import { clearFormAction, setFormValues, submitFormAction } from "containers/Role/actions";
import { useDispatch, useSelector } from "react-redux";
import { createStructuredSelector } from "reselect";
import { makeInitiateCleanFieldSelector, makeErrorSelector, makeIsLoadingSelector } from "containers/Role/selectors";
...
const CreateRoleModal = ({ onCancel, visible }) => {
  ...
  const { errors, device, initiateClean, isLoading } = useSelector(stateSelector);
