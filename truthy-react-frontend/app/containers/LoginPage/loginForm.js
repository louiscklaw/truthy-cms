...
import { makeErrorSelector, makeInitialValuesSelector, makeIsLoadingSelector } from "containers/LoginPage/selectors";
...
const LoginForm = () => {
  ...
  return (
    ...
    >
      ...
      <FormButtonWrapper variant="primary" disabled={isLoading} form={form} label={messages.submit} />
