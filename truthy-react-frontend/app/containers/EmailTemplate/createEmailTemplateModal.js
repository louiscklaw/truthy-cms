...
import { clearFormAction, setFormValues, submitFormAction } from "containers/EmailTemplate/actions";
...
const CreateEmailTemplateModal = ({ onCancel, visible }) => {
  ...
  const { Form, form, body, TitleInput, SubjectInput, SenderInput, BodyInput } = useGetEmailTemplateForm({
