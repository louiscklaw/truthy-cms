  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "users",
        element: (
          <PrivateRoute path="/users" method="get" resource="user" defaultPermission={false}>
            <Users />
          </PrivateRoute>
        ),
      },
      {
        path: "roles",
        element: (
          <PrivateRoute path="/roles" method="get" resource="role" defaultPermission={false}>
            <Role />
          </PrivateRoute>
        ),
      },
      {
        path: "permissions",
        element: (
          <PrivateRoute path="/permissions" method="get" resource="permission" defaultPermission={false}>
            <Permission />
          </PrivateRoute>
        ),
      },
      {
        ...
        element: (
          <PrivateRoute path="/email-templates" method="get" resource="emailTemplates" defaultPermission={false}>
            <EmailTemplate />
          </PrivateRoute>
        ),
      },
      {
        ...
        element: (
          <PrivateRoute path="/account-setting" method="get" resource="user" defaultPermission>
            <UserAccount />
          </PrivateRoute>
        ),
      },
      {
        path: "profile",
        element: (
          <PrivateRoute path="/profile" method="get" resource="user" defaultPermission>
            <Profile />
          </PrivateRoute>
        ),
      },
