  ...
  const menu = (
    <Menu>
      <Menu.Item key="1">
        <span>
          <UserOutlined />
          <span tabIndex={0} aria-hidden="true" role="button" onClick={() => navigate("/profile")}>
      ...
      <Menu.Item key="2">
        <span>
          <SettingOutlined />
          <span tabIndex={0} aria-hidden="true" role="button" onClick={() => navigate("/account-setting")}>
            Account Setting
      ...
      <Menu.Item key="3">
        <span>
          <LogoutOutlined />
          <span tabIndex={0} aria-hidden="true" role="button" onClick={onLogout}>
            <FormattedMessage {...messages.logout} />
          </span>
        </span>
      </Menu.Item>
    ...
    <Header className="layout-page-header">
      {device !== "MOBILE" && (
        <div className="logo" style={{ width: collapsed ? 80 : 200 }}>
          {collapsed ? <img src={ShortLogoSvg} alt="short-logo" /> : <img src={LongLogoSvg} alt="full-logo" />}
        </div>
      )}
      <div className="layout-page-header-main">
        ...
        <div className="actions">
          ...
          {isLogged ? (
            ...
            <span aria-hidden="true" style={{ cursor: "pointer" }} onClick={toLogin}>
