...
const FooterComponent = () => {
  ...
  const [showSettings, setShowSettings] = useLocalStorage("settingsVisible", false);
    ...
    <Footer>
      {showSettings ? (
        <Card>
          ...
          <Button href="https://github.com/gobeam/truthy" target="_blank" type="primary" className="mb-3 w-100">
            <DownloadOutlined />
