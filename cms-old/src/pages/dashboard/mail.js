  ...
  return (
    <>
      ...
      >
        ...
        >
          <MailSidebar containerRef={rootRef} label={label} labels={labels} onClose={handleCloseSidebar} onCompose={handleComposeClick} open={isSidebarOpen} />
          <MailInner open={isSidebarOpen}>
            {emailId ? <MailDetails label={label} emailId={emailId} /> : <MailList onToggleSidebar={handleToggleSidebar} label={label} />}
          </MailInner>
        </Box>
      </Box>
