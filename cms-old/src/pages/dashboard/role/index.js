...
const getComparator = (sortDir, sortBy) => (sortDir === "desc" ? (a, b) => descendingComparator(a, b, sortBy) : (a, b) => -descendingComparator(a, b, sortBy))
        ...
        <Container maxWidth="xl">
          ...
          <Card>
            ...
            >
              ...
              <TextField label="Sort By" name="sort" onChange={handleSortChange} select SelectProps={{ native: true }} sx={{ m: 1.5 }} value={sort}>
