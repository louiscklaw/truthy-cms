  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <UsersIcon fontSize="small" />,
        children: [
          { title: t("List"), path: "/dashboard/role" },
          { title: t("Details"), path: "/dashboard/role/1" },
          { title: t("Edit"), path: "/dashboard/role/1/edit" },
        ],
      },
      {
        title: t("Permission"),
        ...
        icon: <UsersIcon fontSize="small" />,
        children: [
          { title: t("List"), path: "/dashboard/permission" },
          { title: t("Details"), path: "/dashboard/permission/1" },
          { title: t("Edit"), path: "/dashboard/permission/1/edit" },
        ],
      },
      {
        title: t("Customers"),
        ...
        <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
          <Box>
            <Stack direction="column" justifyContent="center" alignItems="center" spacing={2}>
              ...
              <Box sx={{ px: 2 }}>
                <Typography variant="body2">louislabs restaurant</Typography>
              </Box>
            </Stack>
          </Box>
